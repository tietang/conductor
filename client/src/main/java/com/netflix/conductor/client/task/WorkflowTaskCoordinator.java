...
import static com.netflix.conductor.client.telemetry.MetricsContainer.getPollTimer;
import static com.netflix.conductor.client.telemetry.MetricsContainer.incrementTaskPollCount;

/**
 * This class has been deprecated and will be removed in a future release.
 * Please use {@link com.netflix.conductor.client.automator.TaskRunnerConfigurer} instead.
 */
@Deprecated
